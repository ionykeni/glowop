...
export default function ReleasedPeriodAllocations({ allocations, tents, groupId, onReAdd, onDismissed }) {
  ...
  const dismiss = async () => {
    ...
    try {
      ...
      toast.success("השיבוץ הוסר מהרשימה");
    } catch (error) {
